...
<div class="row">
	...
	<div class="form-group"> 
        ...
        <div class="col-sm-10">
		    <input type="submit" name="btnLogin" style = " background-color: pink; color:black" class="btn btn-primary" id="btnLogin" value="Login"/>
            <input type="submit" name="btnCancel" style = " background-color: pink; color:black" class="btn btn-primary" id="btnLogin"  value="Cancel"/>
			<div><br></div>
		</div>  
	</div>
 </div>
